...
import { FileCheck, MessageSquare, Printer, Truck } from "lucide-react";
...
const steps = [
  {
    ...
    description:
      "Contact us via WhatsApp, call, or quote form with your requirements",
  },
  {
    icon: FileCheck,
    title: "2. Design & Quote",
    description:
      "We'll provide a free mockup and competitive pricing within hours",
  },
  {
    icon: Printer,
    title: "3. Production",
    description:
      "Your order goes into production with quality checks at every stage",
  },
  {
    icon: Truck,
    title: "4. Delivery",
    description:
      "Fast delivery across Dubai with professional installation if needed",
  },
];
