  ...
  return (
    <form ref={formRef} onSubmit={onSubmit} className="space-y-3">
        <input 
          ...
          className="w-full rounded-lg p-3 text-[var(--foreground)] placeholder:text-[var(--foreground)]/55 bg-[var(--surface-1)] border border-white/15 focus:ring-2 focus:ring-[var(--color-accent-500)] focus:border-[var(--color-accent-500)] transition-all" 
        />
        <input 
          name="phone" 
          required 
        ...
        <textarea 
          ...
          rows={4}
          className="w-full rounded-lg p-3 text-[var(--foreground)] placeholder:text-[var(--foreground)]/55 bg-[var(--surface-1)] border border-white/15 focus:ring-2 focus:ring-[var(--color-accent-500)] focus:border-[var(--color-accent-500)] transition-all resize-none" 
        />
        <input 
          name="file" 
          type="file" 
          className="w-full rounded-lg p-3 text-[var(--foreground)] bg-[var(--surface-1)] border border-white/15 focus:ring-2 focus:ring-[var(--color-accent-500)] focus:border-[var(--color-accent-500)] transition-all file:mr-4 file:py-2 file:px-4 file:rounded-lg file:border-0 file:text-sm file:font-semibold file:bg-[var(--color-accent-100)] file:text-[var(--color-accent-700)] hover:file:bg-[var(--color-accent-200)]" 
        />
        <button 
          disabled={pending} 
