            ...
            action: {
              ...
              onClick: () => {
                ...
                window.open(
                  createWhatsAppLink(
                    phoneNumber,
                    "Hi! I just submitted an order and would like to discuss it further."
                  ),
                  "_blank"
                );
              },
  ...
  return (
    <form ref={formRef} onSubmit={onSubmit} className="space-y-4">
      ...
      <div className="space-y-3">
        ...
        <div className="space-y-2">
          ...
          <p className="text-xs text-[var(--color-ink)]/60">
            Supported formats: Images (JPG, PNG), PDF, AI, EPS, PSD, CDR. Max
            size: 10MB
          </p>
      ...
      <p className="text-xs text-center text-[var(--color-ink)]/60">
        By submitting, you agree to our terms. We&apos;ll contact you to confirm
        your order and discuss payment.
      </p>
    </form>
  );
}
