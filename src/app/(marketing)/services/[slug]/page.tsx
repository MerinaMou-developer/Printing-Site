...
export default async function ServicePage({
  ...
  const waLink = createWhatsAppLink(
    phoneNumber,
    `Hi! I'm interested in your ${s.name} service. Can you help me?`
  );
  ...
  const currentSpecs = specifications[
    s.slug as keyof typeof specifications
  ] || {
  ...
  const faqs =
    ...
    },
    {
      ...
      answer: `Our standard turnaround time for ${s.name.toLowerCase()} is ${
        currentSpecs.turnaround
    ...
    {
      question: "Do you deliver across Dubai?",
      answer:
        "Yes, we provide delivery and installation services across Dubai, including all major areas like Downtown, Marina, JBR, and surrounding emirates.",
    },
    {
      question: "What file formats do you accept?",
      answer:
        "We accept all major file formats including PDF, AI, EPS, PSD, and high-resolution images. We also provide file preparation services if needed.",
    },
    {
      question: "Do you offer bulk discounts?",
      answer:
        "Yes, we offer competitive pricing for bulk orders. The larger the quantity, the better the price per unit. Contact us for a detailed quote.",
    },
  ];
    ...
    <>
            ...
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-3 gap-6 pt-6">
                <div className="text-center">
                  <div className="text-2xl font-bold text-[var(--color-accent-400)]">
                    500+
                  </div>
                ...
                <div className="space-y-4">
                  <div className="relative aspect-square rounded-2xl overflow-hidden bg-gradient-to-br from-[var(--color-brand-100)] to-[var(--color-brand-200)] group">
                    <div className="absolute inset-0 flex items-center justify-center">
                      <span className="text-6xl font-bold text-[var(--color-brand-600)]">
                        {s.name.charAt(0)}
                      </span>
                    </div>
      ...
      <section className="wrapper py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-white max-w-2xl mx-auto">
            See examples of our professional {s.name.toLowerCase()} work for
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
          {serviceImages.map((image, index) => (
            <div
              key={index}
              className="group relative aspect-square rounded-2xl overflow-hidden bg-gradient-to-br from-[var(--color-brand-100)] to-[var(--color-brand-200)] hover:shadow-xl transition-all duration-300"
            >
              <div className="absolute inset-0 flex items-center justify-center">
        ...
        <div className="grid lg:grid-cols-3 gap-12">
          ...
          <div className="lg:col-span-2 space-y-12">
              ...
              <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                <div className="space-y-4">
                  ...
                  <div className="bg-gradient-to-r from-[var(--color-accent-50)] to-[var(--color-accent-100)] p-4 rounded-xl border border-[var(--color-accent-200)]">
                    <div className="text-lg font-bold text-[var(--color-accent-600)]">
                      {currentSpecs.turnaround}
                    </div>
                ...
                <div className="space-y-4">
                  ...
                  <div className="bg-gradient-to-r from-[var(--color-brand-50)] to-[var(--color-brand-100)] p-4 rounded-xl border border-[var(--color-brand-200)]">
                    <div className="text-lg font-bold text-[var(--color-brand-600)]">
                      {currentSpecs.moq}
                    </div>
                    <div className="text-sm text-white">For best pricing</div>
                  </div>
                </div>
                ...
                {[
                  {
                    step: "1",
                    title: "Consultation",
                    desc: "Free design consultation and quote",
                    icon: MessageCircle,
                  },
                  {
                    step: "2",
                    title: "Design",
                    desc: "Custom design or artwork preparation",
                    icon: Palette,
                  },
                  {
                    step: "3",
                  ...
                  },
                  {
                    step: "4",
                    title: "Delivery",
                    desc: "Installation and delivery across Dubai",
                    icon: Truck,
                  },
                ].map((process, idx) => (
                  <div key={idx} className="text-center space-y-4">
                    ...
                    <p className="text-sm text-white">{process.desc}</p>
                  </div>
                ))}
              </div>
            </div>
            ...
            <div className="card border-2 border-[var(--border)] p-8 rounded-2xl">
              ...
              <div className="space-y-4">
                {[
                  {
                    q: `What is the minimum order quantity for ${s.name.toLowerCase()}?`,
                    a: `Our minimum order quantity varies by service type. For ${s.name.toLowerCase()}, we typically require ${
                      currentSpecs.moq
                    }. Contact us for specific requirements.`,
                  },
                  {
                    q: `How long does ${s.name.toLowerCase()} take?`,
                    a: `Our standard turnaround time for ${s.name.toLowerCase()} is ${
                      currentSpecs.turnaround
                    }. Rush orders may be available for an additional fee.`,
                  },
                  {
                    q: `Do you provide design services?`,
                    a: "Yes! We offer free design consultation and can create custom designs for your project. Our experienced designers will work with you to bring your vision to life.",
                  },
                  {
                    q: "Do you deliver across Dubai?",
                    a: "Yes, we provide delivery and installation services across Dubai, including all major areas like Downtown, Marina, JBR, and surrounding emirates.",
                  },
                  {
                    q: "What file formats do you accept?",
                    a: "We accept all major file formats including PDF, AI, EPS, PSD, and high-resolution images. We also provide file preparation services if needed.",
                  },
                  {
                    q: "Do you offer bulk discounts?",
                    a: "Yes, we offer competitive pricing for bulk orders. The larger the quantity, the better the price per unit. Contact us for a detailed quote.",
                  },
                ].map((faq, i) => (
                  <details
                    key={i}
                    className="group rounded-xl border-2 border-[var(--border)] p-6 bg-white hover:border-[var(--color-accent-400)] transition-all duration-300"
                  >
          ...
          <div className="space-y-6">
            ...
            <div className="card border-2 border-[var(--border)] p-6 rounded-2xl">
              ...
              <h3 className="font-bold text-xl text-center text-[var(--color-brand-700)] mb-2">
                {s.name}
              </h3>
              <p className="text-center text-white text-sm">{s.desc}</p>
            </div>
            ...
            <div className="card border-2 border-[var(--border)] p-6 rounded-2xl">
              ...
              <div className="space-y-4">
                {[
                  ...
                  <div
                    key={idx}
                    className="flex items-center gap-3 p-3 rounded-xl bg-gradient-to-r from-[var(--color-accent-50)] to-[var(--color-accent-100)] border border-[var(--color-accent-200)] hover:shadow-md transition-all"
                  >
                    <benefit.icon
                      className={`h-5 w-5 text-${benefit.color}-600 flex-shrink-0`}
                    />
      ...
      <section className="bg-[var(--surface-2)] py-16">
        <div className="wrapper">
          <h2 className="text-3xl font-bold mb-4 text-center text-[var(--color-brand-700)]">
            Related Services
          </h2>
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {services
              .filter(
                (service) =>
                  service.category === s.category && service.slug !== s.slug
              )
              .slice(0, 3)
              .map((related) => (
                <Link
