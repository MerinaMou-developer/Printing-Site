          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg text-white/90 leading-relaxed mb-8">
                {product.desc} - Professional printing and customization
                services by PrimePrint Dubai in Dubai.
              </p>

              <div className="flex flex-wrap gap-4">
                <Link
                  href="/contact"
                  className="btn glass text-white text-lg px-8 py-4 hover:bg-white/15"
                >
                  Get Free Quote
                </Link>
                {wa && (
        ...
        <div className="grid lg:grid-cols-3 gap-12">
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            <div className="card border-2 border-[var(--border)] p-8">
              <h2 className="text-2xl md:text-3xl font-bold mb-6 text-[var(--color-brand-700)]">
                Product Features
              </h2>

              <div className="grid md:grid-cols-2 gap-6">
                <div className="space-y-4">
                  <h3 className="text-xl font-semibold text-[var(--color-brand-600)]">
                ...
                <table className="w-full border-collapse">
                  <thead>
                    <tr className="bg-[var(--color-brand-100)]">
                      <th className="border border-[var(--border)] p-3 text-left font-semibold text-[var(--color-brand-700)]">
                        Specification
                      </th>
                      <th className="border border-[var(--border)] p-3 text-left font-semibold text-[var(--color-brand-700)]">
                        Details
                  ...
                  <tbody>
                    <tr>
                      <td className="border border-[var(--border)] p-3 font-medium">
                        Material
                      </td>
                    ...
                    <tr className="bg-[var(--surface-2)]">
                      ...
                      <td className="border border-[var(--border)] p-3">
                        Screen printing, DTF, or digital printing
                      </td>
                    </tr>
                    <tr>
                      <td className="border border-[var(--border)] p-3 font-medium">
          ...
          <div className="space-y-6">
            ...
            <div className="card border-2 border-[var(--border)] p-6">
              ...
              <h3 className="font-bold text-lg text-center text-[var(--color-brand-700)]">
                {product.name}
              </h3>
            </div>
            ...
            <div className="card border-2 border-[var(--border)] p-6">
              ...
              <div className="space-y-3">
                <div className="flex justify-between items-center p-3 rounded-xl bg-[var(--color-accent-50)] border border-[var(--color-accent-200)]">
                  ...
                  <span className="text-[var(--color-accent-600)] font-bold">
                    AED 25-35
                  </span>
                </div>
                <div className="flex justify-between items-center p-3 rounded-xl bg-[var(--color-accent-50)] border border-[var(--color-accent-200)]">
            ...
            <div className="card border-2 border-[var(--border)] p-6">
              ...
              <div className="space-y-3">
                {[
                  ...
                  <div
                    key={idx}
                    className="flex items-center gap-3 p-3 rounded-xl bg-gradient-to-r from-[var(--color-accent-50)] to-[var(--color-accent-100)] border border-[var(--color-accent-200)]"
                  >
        ...
        <div className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-[var(--color-brand-800)] to-[var(--color-brand-600)] p-12 md:p-16 text-center text-white shadow-2xl">
          ...
          <div className="relative z-10">
            <h2 className="text-3xl md:text-4xl font-bold mb-4">
              Ready to Customize Your {product.name}?
            </h2>
